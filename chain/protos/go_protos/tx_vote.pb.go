...
func (m *TxVoteIn) GetRate() uint32 {
	if m != nil {
		return m.Rate
	}
	return 0
...
var fileDescriptor_82ebbf5ccea440ca = []byte{
	...
	,
}
...
func (m *TxVoteIn) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Rate != 0 {
		i = encodeVarintTxVote(dAtA, i, uint64(m.Rate))
		i--
		dAtA[i] = 0x28
	}
	if len(m.VoteAddr) > 0 {
