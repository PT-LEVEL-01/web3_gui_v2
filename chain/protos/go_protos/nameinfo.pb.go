...
type Nameinfo struct {
	...
	IsMultName           bool     `protobuf:"varint,9,opt,name=IsMultName,proto3" json:"IsMultName,omitempty"`
...
func (m *Nameinfo) GetIsMultName() bool {
	if m != nil {
		return m.IsMultName
	}
	return false
...
var fileDescriptor_998d3ff6fede2178 = []byte{
	...
	0xb3, 0x8a, 0x95, 0x7e, 0x30, 0x72, 0x71, 0xf8, 0x41, 0x65, 0x85, 0x84, 0xb8, 0x58, 0x40, 0x6c,
	...
	0x0e, 0x56, 0x00, 0xe3, 0x0a, 0x89, 0x70, 0xb1, 0xfa, 0x97, 0xe7, 0xa5, 0x16, 0x49, 0x70, 0x80,
	0x1d, 0x09, 0xe1, 0x08, 0xc9, 0x71, 0x71, 0x79, 0x16, 0xfb, 0x96, 0xe6, 0x94, 0x80, 0xfd, 0xc4,
	0xa9, 0xc0, 0xa8, 0xc1, 0x11, 0x84, 0x24, 0xe2, 0x24, 0x7b, 0xe2, 0x91, 0x1c, 0xe3, 0x85, 0x47,
	0x72, 0x8c, 0x0f, 0x1e, 0xc9, 0x31, 0xce, 0x78, 0x2c, 0xc7, 0x10, 0xc5, 0xad, 0xa7, 0x0f, 0x0f,
	0x99, 0x24, 0x36, 0x30, 0x6d, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x8b, 0x67, 0xa4, 0x35, 0x3d,
	0x01, 0x00, 0x00,
}
...
func (m *Nameinfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Owner) > 0 {
		i -= len(m.Owner)
		copy(dAtA[i:], m.Owner)
		i = encodeVarintNameinfo(dAtA, i, uint64(len(m.Owner)))
		i--
		dAtA[i] = 0x42
	}
	if m.Deposit != 0 {
...
func (m *Nameinfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsMultName", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
