...
func (m *TxDepositIn) GetRate() uint32 {
	if m != nil {
		return m.Rate
	}
	return 0
...
var fileDescriptor_f9a42da7a162cae6 = []byte{
	...
	0xb3, 0x8a, 0xa5, 0x78, 0x4a, 0x2a, 0x92, 0x12, 0x8b, 0x53, 0x21, 0x12, 0x4a, 0x71, 0x5c, 0xdc,
	...
	0x9e, 0x20, 0x10, 0x53, 0x48, 0x88, 0x8b, 0x25, 0x28, 0xb1, 0x24, 0x55, 0x82, 0x59, 0x81, 0x51,
	0x83, 0x37, 0x08, 0xcc, 0x56, 0xb2, 0xe4, 0xe2, 0x81, 0x9b, 0xef, 0x5f, 0x5a, 0x42, 0x82, 0x05,
	0x4e, 0xb2, 0x27, 0x1e, 0xc9, 0x31, 0x5e, 0x78, 0x24, 0xc7, 0xf8, 0xe0, 0x91, 0x1c, 0xe3, 0x8c,
	0xc7, 0x72, 0x0c, 0x51, 0xdc, 0x7a, 0xfa, 0x70, 0xd5, 0x49, 0x6c, 0x60, 0xda, 0x18, 0x10, 0x00,
	0x00, 0xff, 0xff, 0x17, 0x1b, 0xe2, 0xd5, 0xeb, 0x00, 0x00, 0x00,
}
...
func (m *TxDepositIn) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Rate != 0 {
		i = encodeVarintTxDepos(dAtA, i, uint64(m.Rate))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Puk) > 0 {
