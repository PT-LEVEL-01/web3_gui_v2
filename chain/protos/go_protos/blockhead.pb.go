...
type BlockHead struct {
	...
	ExtSign              [][]byte `protobuf:"bytes,13,rep,name=ExtSign,proto3" json:"ExtSign,omitempty"`
...
func (m *BlockHead) GetExtSign() [][]byte {
	if m != nil {
		return m.ExtSign
	}
	return nil
...
var fileDescriptor_73a80c2de40f4050 = []byte{
	...
	,
}
...
func (m *BlockHead) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ExtSign) > 0 {
		for iNdEx := len(m.ExtSign) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.ExtSign[iNdEx])
			copy(dAtA[i:], m.ExtSign[iNdEx])
			i = encodeVarintBlockhead(dAtA, i, uint64(len(m.ExtSign[iNdEx])))
			i--
			dAtA[i] = 0x6a
		}
	}
...
func (m *BlockHead) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExtSign", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExtSign = append(m.ExtSign, make([]byte, postIndex-iNdEx))
			copy(m.ExtSign[len(m.ExtSign)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
