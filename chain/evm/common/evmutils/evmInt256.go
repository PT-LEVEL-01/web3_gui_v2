...
func (i *Int) NegV1(y *Int) *Int {
	i = New(0).Sub(y)
	return i
}

func (i *Int) SDivV0(y *Int) *Int {
	if i.SignV1() > 0 {
		if y.SignV1() > 0 {
			// pos / pos
			i.Div(y)
