 ...
 *  对比最新以太坊操作码，缺少KECCAK256、PREVRANDAO、CHAINID、BASEFEE、INVALID。其中KECCAK256对应当前SHA3，PREVRANDAO在EIP4399中替代DIFFICULTY操作码
 *  CHAINID 链的id,BASEFEE基础费
 */
...
const (
	...
	TIMESTAMP
	NUMBER
	DIFFICULTY //same RANDOM PREVRANDAO
	GASLIMIT
)

const (
	unusedX46 OpCode = iota + 0x46 //chainid
	SELFBALANCE
	unusedx48 //BASEFEE
	unusedX49
	unusedX4A
...
const (
	INVALID OpCode = iota + 0xFE //no action
)
...
// OpCodeMap just for debugging, don't remove it
