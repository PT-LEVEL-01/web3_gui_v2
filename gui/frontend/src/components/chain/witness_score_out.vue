<template>
<div>
      <el-page-header @back="goBack" content="取消质押">
    </el-page-header>
...
import { Chain_GetCommunityList } from '../../../bindings/web3_gui/gui/server_api/sdkapi'
...
function submitForm(formName) {
  thistemp.$refs[formName].validate((valid) => {
    ...
    //     txid:store.witnessScoreOut.Txid,amount:amount,gas:gas,pwd:ruleForm.value.pass}}
    // console.log(params);
