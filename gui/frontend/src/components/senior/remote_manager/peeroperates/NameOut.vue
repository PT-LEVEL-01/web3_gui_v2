...
import {Depositout, NameOut} from '../../../../../bindings/web3_gui/gui/server_api/sdkapi'
...
const submitForm = async (formEl: FormInstance | undefined) => {
    ...
    await formEl.validate((valid, fields) => {
        if (valid) {
            NameOut(store.getPeerInfo().id,ruleForm.address,parseFloat(ruleForm.amount.toString()),parseFloat(ruleForm.gas.toString()),ruleForm.pass,ruleForm.name,ruleForm.comment).then((result) => {
