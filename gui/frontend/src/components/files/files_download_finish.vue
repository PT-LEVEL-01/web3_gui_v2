...
import { File_StopDownload, File_StartDownload, File_DelDownload, Storage_Client_downloadList, Storage_Client_downloadFinishList }
...
const flashDownloadList = () => {
  Promise.all([Storage_Client_downloadFinishList("",10)]).then(messages => {
