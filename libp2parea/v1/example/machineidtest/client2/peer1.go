...
func StartAllPeer() {
	...
	// 		utils.Log.Info().Msgf("cur:%s curmachineID:%s target:%s tmachineID:%s", areaPeers[i].area.GetNetId().B58String(), areaPeers[i].area.GetMachineID(), logicNodes[ii].IdInfo.Id.B58String(), logicNodes[ii].GetMachineID)
	// 	}
