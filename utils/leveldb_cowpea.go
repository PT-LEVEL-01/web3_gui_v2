...
// 保存到豇豆藤集合中
// */
// func (this *LevelDB) SaveCowpeaVine(dbkey, key, value []byte) (uint64, error) {
// 	var err error
...
// /*
// 修改豇豆藤集合中的一个key的value值
// */
// func (this *LevelDB) UpdateCowpeaVineByIndex(dbkey, key []byte, index uint64, value []byte) error {
// 	var err error
// 	if dbkey, err = LeveldbBuildKey(dbkey); err != nil {
// 		return err
// 	}
...
// /*
// 查找豇豆藤集合中的一个key的value值
// */
// func (this *LevelDB) FindCowpeaVineByIndex(dbkey, key []byte, index uint64) ([]byte, error) {
// 	var err error
// 	if dbkey, err = LeveldbBuildKey(dbkey); err != nil {
// 		return nil, err
// 	}
...
// 删除豇豆藤集合中的一个key
// */
// func (this *LevelDB) RemoveCowpeaVineByKey(dbkey, key []byte) error {
// 	var err error
// 	if dbkey, err = LeveldbBuildKey(dbkey); err != nil {
// 		return err
// 	}
...
// */
// func (this *LevelDB) RemoveCowpeaVineByKeyInterval(dbkey, key []byte, num uint64, interval time.Duration) error {
// 	var err error
// 	if dbkey, err = LeveldbBuildKey(dbkey); err != nil {
// 		return err
// 	}
...
// 删除豇豆藤集合中的一个item
// */
// func (this *LevelDB) RemoveCowpeaVineByIndex(dbkey, key []byte, index uint64) error {
// 	var err error
// 	if dbkey, err = LeveldbBuildKey(dbkey); err != nil {
// 		return err
// 	}
...
// 查询豇豆藤集合中所有key
// */
// func (this *LevelDB) FindCowpeaVineAllKeyToList(dbkey []byte) ([]DBItem, error) {
// 	var err error
// 	if dbkey, err = LeveldbBuildKey(dbkey); err != nil {
// 		return nil, err
// 	}
...
// 查询豇豆藤集合中一个key下的列表
// */
// func (this *LevelDB) FindCowpeaVineKeyList(dbkey, key []byte) ([]DBItem, error) {
// 	oldKey := key
// 	var err error
// 	if dbkey, err = LeveldbBuildKey(dbkey); err != nil {
// 		return nil, err
...
// /*
// 查询豇豆藤集合中一个key下的列表记录总数
// */
// func (this *LevelDB) FindCowpeaVineCount(dbkey, key []byte) (uint64, error) {
// 	var err error
// 	if dbkey, err = LeveldbBuildKey(dbkey); err != nil {
// 		return 0, err
// 	}
